//
//  InnerTableFixedViewController.m
//  TableViewInCell
//
...
@interface InnerTableFixedViewController ()<PullListTableDelegate,UITableViewDelegate,UITableViewDataSource,MainContentCellDelegate>
@property(nonatomic,strong)PullListTableView *tableView;
@property (nonatomic,strong) NSMutableArray *dataArray;

@end

@implementation InnerTableFixedViewController
